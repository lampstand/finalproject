...
class gsp_project_tithePaymentlist_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/tithePayment/list.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(21)
invokeTag('paginate','g',62,['total':(tithePaymentInstanceTotal)],-1)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1385699160611L
